    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <StatCard
          label="In progress"
          value={activeCount}
          sub={activeCount > 0 ? 'rendering now' : 'none active'}
        />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        >
          ...
          <p className="text-sm text-gray-500 mt-1">Design a reusable template with placeholders</p>
        </Link>
        ...
        >
          ...
          <p className="text-sm text-gray-500 mt-1">Upload CSV and generate designs in bulk</p>
        </Link>
        ...
        >
          ...
          <p className="text-sm text-gray-500 mt-1">Top up your wallet to generate more designs</p>
        </Link>
      </div>
      ...
      {templates.length > 0 && (
        <div className="card">
          <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
            ...
            <Link to="/templates" className="text-sm text-brand-600 hover:underline">
              View all
            </Link>
          </div>
